...
//        break;
//    case 2:
//        // Add your ticket booking function call here
//        break;
//    case 3:
...
//
//void schedule() {
//    char searchArrivalStation[50]; // Changed to character array
//    int count = 0;
//
...
//    printf("==============================================================================================================================\n");
//
//    printf("Press any key to start searching.\n");
//    getchar(); // Wait for user to press any key
//
//    printf("Searching based on Arrival Station: \n");
//    printf("Arrival Station > ");
//    fgets(searchArrivalStation, sizeof(searchArrivalStation), stdin); // Use fgets to safely read input
//
//    // Remove trailing newline character from searchArrivalStation
//    if (searchArrivalStation[strlen(searchArrivalStation) - 1] == '\n')
//        searchArrivalStation[strlen(searchArrivalStation) - 1] = '\0';
//
//    for (int i = 0; i < 6; i++) {
//        if (strcmp(searchArrivalStation, scheduleList[i].arrivalStation) == 0) {
//            printf(" %s\t  %s\t %-30s\t %s\t\t %s\t \t%d\t\n", scheduleList[i].trainNum, scheduleList[i].departureStation, scheduleList[i].arrivalStation, scheduleList[i].departureTime, scheduleList[i].arrivalTime, scheduleList[i].availableSeat);
//            count++;
//        }
//    }
//
//    if (count == 0) {
//        printf("No trains found arriving at %s.\n", searchArrivalStation);
//    }
//}
